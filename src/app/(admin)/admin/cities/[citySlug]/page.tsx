...
import { uploadCityImage, removeCityImage } from "../actions";
import { AdminCityImageUpload } from "./admin-city-image-upload";
import { CityEditForm } from "@/components/admin/city-edit-form";
...
export default async function EditCityPage({
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      {/* City details form (client component — no-reload save, ⌘S, sticky bar, toasts) */}
      <CityEditForm city={city} countryOptions={countryOptions} />

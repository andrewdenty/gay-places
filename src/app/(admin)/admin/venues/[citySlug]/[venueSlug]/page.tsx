...
export default async function EditVenuePage({
  ...
  // Resolve city first (no published filter — admins can edit venues in hidden cities)
  ...
  // Fetch venue by city_id + slug (no published filter — admins can edit hidden venues)
            ...
            {photos.map((photo) => (
              <div key={photo.id} className="group relative">
                ...
                <form action={deleteVenuePhoto}>
                  ...
                  <input type="hidden" name="venue_city_slug" value={city.slug} />
                  <button
                    type="submit"
